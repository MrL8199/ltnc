		...
		<div class="content">
			...
			<div class="row">
				<div class="col-sm-4">
					...
					<%if(kh!=null){ %>
					<div class="row">
						<P>Mã khách hàng:<%out.print(kh.getMaKH()); %></P>
						<p>Tên tài khoản:<%out.print(kh.getTenTKKH()); %></p>
						<p>Tên khách hàng:<%out.print(kh.getTenKH()); %></p>
						<p>Số điện thoại:<%out.print(kh.getSdtKH()); %></p>
					</div>
					<div class="row">
