			...
			<div class="col-md-9">
				...
				<div class="col-md-7 single-top-in">
					<div class="single-para">
						...
						<div class="para-grid">
							<span class="add-to">$32.8</span> <a href="#" class=" cart-to">Add
								to Cart</a>
			...
			<div class="col-md-3 col-md">
				<div class=" possible-about">
					...
					<div class="tab2">
						...
						<div class="single-bottom">
							...
							</a> <a href="#"> <input type="checkbox" id="nike3" value="">
								<label for="nike3"><span></span> <b>Puma</b></label>
							</a> <a href="#"> <input type="checkbox" id="nike4" value="">
					...
					<div class="tab3">
						<ul class="place">
							...
							<li class="sort">Sort by <span>colour</span>
							</li>
							<li class="by"><img src="images/do.png" alt=""></li>
							<div class="clearfix"></div>
						</ul>
					...
					<div class="tab4">
						<ul class="place">
							...
							<li class="sort">Sort by <span>discount</span>
							</li>
							<li class="by"><img src="images/do.png" alt=""></li>
							<div class="clearfix"></div>
						</ul>
					...
					<div class="tab5">
						<ul class="place">
							...
							<li class="sort">Sort by <span>rating</span>
							</li>
							<li class="by"><img src="images/do.png" alt=""></li>
							<div class="clearfix"></div>
						</ul>
				...
				<div class="content-bottom-grid">
					...
					<div class="latest-grid">
						...
						<div class="news-in">
							<h6>
								<a href="single.html">Product name here</a>
							</h6>
				...
				<div class="money">
					...
					<ul class="money-in">
						<li><a href="single.html"><img class="img-responsive"
